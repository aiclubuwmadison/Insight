...
> Built a hybrid VS Code code-analysis tool using FastAPI, Gemini, Tree-sitter, and scikit-learn to explain selected code and classify common algorithmic patterns locally before falling back to LLM analysis.

Metric-based version:

> Benchmarked a 99.0% median latency reduction for recognized algorithmic patterns by routing high-confidence Tree-sitter/scikit-learn AST predictions around Gemini, with fallback for unknown code.
...
Then launch the extension using VS Code’s Extension Development Host.
